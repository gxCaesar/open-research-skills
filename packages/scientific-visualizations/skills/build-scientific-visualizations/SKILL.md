...
description: Use when creating, redesigning, planning, or visually auditing a scientific figure, flowchart, method schematic, model-architecture diagram, graphical abstract, compound figure, conference figure set, or journal main, Extended Data, and Supplementary figure set, including requests mentioning scientific figure, flowchart, 方法示意图, 模型架构图, Nature-style figure, or publication-ready visual. This skill owns the visual artifact; manuscript-wide claim, venue, and package audits remain with the conference or journal manuscript skill. For a funding-proposal visual, use this skill for graphical construction only after writing-funding-proposals has locked the proposal-specific policy, evidence, and argument.
---
...
PPTX reconstruction** by default. This includes schematic panels inside compound,
...
This skill owns visual construction and visual QA. Conference and journal manuscript
skills may request one of its modes but own venue prose, captions in context, and the
submission package. The publication pipeline owns the experimental contract and
claim scope; this skill visualizes that contract without changing it.
