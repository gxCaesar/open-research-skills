"""Check the develop-method-to-sota install unit, its declared modes and its public content."""
...
class MethodDevelopmentContractTest(unittest.TestCase):
    ...
    def test_a_removed_reading_target_is_rejected(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            mutated = Path(tmp) / "develop-method-to-sota"
