"""Check the survey-and-audit-novelty install unit, its declared modes and its public content."""
...
class SurveyAndNoveltyContractTest(unittest.TestCase):
    ...
    def test_a_removed_reading_target_is_rejected(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            mutated = Path(tmp) / "survey-and-audit-novelty"
