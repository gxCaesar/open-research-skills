"""Check the release-research-artifacts install unit, its declared modes and its public content."""
...
class ArtifactReleaseContractTest(unittest.TestCase):
    ...
    def test_a_removed_reading_target_is_rejected(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            mutated = Path(tmp) / "release-research-artifacts"
