...
Use the local [standalone figures](standalone-figures.md) route, optionally enhanced by
`build-scientific-visualizations` when installed. Agree on the figure's question and use the same object names and
